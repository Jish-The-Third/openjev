...
// READ THE COMMENTS BEFORE STARTING THE PROGRAM. THE BOT WILL NOT WORK WITHOUT THE INFOMRATION BEING FILLED IN!!!!!
  ...
  const bot = mineflayer.createBot({
    host: 'Jevalent.aternos.me', // This is the ip address, or hostname, of your server, an example of this would be Jevalent.aternos.me (it's our demo server). If you leave this blank the bot won't do anything
    port: '28047', // This is all the numbers after the server's colon. An example would be Jevalent.aternos.me:28047 would be just 28047
    username: 'Jevalent2000@hotmail.com', // minecraft username, only leave blank for some servers that are 'offline'
    password: 'Snakes75', // Only use this if your going to have an account with that the bot is controlling!!!
    auth: 'microsoft' // If you usinga microsoft account, set this to 'microsoft'
  })
